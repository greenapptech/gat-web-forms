	...
	<div class="main-wpr">
		<div class="container">
			<div class="form-layout ">
				<form id="report_editform" class="cutom-from" action="<?php echo base_url();?>index.php/welcome/update_form2" method="post">
					...
					<div class="from-inner row">
						<div class="col-md-12">
							<div class="table responsive custom-table">
								...
								<table class="table table-bordered">
									...
									<tbody>
										<tr>
											<td style="width: 50%;"><label>Name</label><input type="text" name="name" class="form-control" value="<?php echo $value['name']; ?>">
										...
										<tr>
											...
											<td><label>Phone</label><input type="text" name="phone" class="form-control" value="<?php echo $value['phone']; ?>">
										</tr>
										<tr>
												...
												<div class="row">
													<div class="col-md-4">
														<div class="form-group row">
															...
															<div class="col-md-6">
																<input type="text" name="inc_date" class="form-control custom-datepicker" value="<?php echo $value['inc_date']; ?>">
													...
													<div class="col-md-4">
														<div class="form-group row">
															...
															<div class="col-md-6">
																<input type="text" name="time_inc" class="form-control custom-timepicker" value="<?php echo $value['time_inc']; ?>">
															</div>
														</div>
													</div>
													<div class="col-md-4">
													...
													<div class="col-md-4">
														<div class="form-group row">
															...
															<div class="col-md-6">
																<input type="text" name="re_date" class="form-control custom-datepicker" value="<?php echo $value['re_date']; ?>">
													...
													<div class="col-md-4">
														<div class="form-group row">
															...
															<div class="col-md-6">
																<input type="text" name="time_re" class="form-control custom-timepicker" value="<?php echo $value['time_re']; ?>">
															</div>
														</div>
													</div>
													<div class="col-md-4">
										...
										<tr>
											...
											<td><textarea name="list_item" class="form-control"> <?php echo $value['list_item']; ?></textarea>
										</tr>
										<tr>
											<td><label>Item (s) Identification Number(s) / Serial number</label></td>
											<td><textarea name="item_no" class="form-control"><?php echo $value['item_no']; ?></textarea>
										</tr>
										<tr>
											<td><label>Item (s) Location at Time of Damage / Loss / Stolen</label></td>
											<td><textarea name="item_loc" class="form-control" ><?php echo $value['item_loc']; ?></textarea>
										</tr>
										<tr>
											<td><label>How Was the item (s) Damaged / Lost / Stolen? (Detail Description)</label></td>
											<td><textarea name="item_damaged" class="form-control"><?php echo $value['item_damaged']; ?></textarea>
										</tr>
										<tr>
											<td><label>Estimated cost of repair/replacement</label></td>
											<td><textarea name="cost_repair" class="form-control"><?php echo $value['cost_repair']; ?></textarea>
										</tr>
										<tr>
											<td><label>Person responsible for assets/materials</label></td>
											<td><textarea name="parson_assets" class="form-control"><?php echo $value['parson_assets']; ?></textarea>
										</tr>
									</tbody>
								</table>
							</div>
						...
						<div class="col-md-12">
							<div class="radio radio-success">
								<input type="radio" name="question" id="yes" <?php if($value['question']=='yes'){ echo "checked=checked";}  ?> value="yes"> 
								<label for="yes"> Yes </label>
							</div>
						
							<div class="radio radio-success">
								<input type="radio" name="question" id="no" <?php if($value['question']=='no'){ echo "checked=checked";}  ?> value="no"> 
						...
						<div class="col-md-12">
							<div class="table responsive custom-table">
								<table class="table table-bordered">
									...
									<tbody>
										<tr>
											<td style="width: 50%;"><label>Police Report</label><input type="text" name="police_report" class="form-control" value="<?php echo $value['police_report']; ?>">
											<span class="text-danger"><?php echo form_error('police_report'); ?></span></td>
											<td><label>Station/City</label><input type="text" name="city" class="form-control" value="<?php echo $value['city']; ?>">
										</tr>
					...
					<div class="from-footer row">
						<div class="col-md-12">
							...
							<div class="form-group">
								...
								<button type="button" id="Sevebtn" name="save" class="btn btn-success btn-custom">Save &amp; Preview</button>
							</div>
						</div>
					</div>					
				</form>
